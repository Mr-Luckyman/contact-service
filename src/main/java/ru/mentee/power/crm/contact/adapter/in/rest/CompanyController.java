...
public class CompanyController {
  ...
  public ResponseEntity<CompanyResponse> createCompany(
    ...
    return ResponseEntity.created(URI.create("/api/v1/companies/" + company.getId()))
  ...
  public ResponseEntity<List<CompanyResponse>> listCompanies(
    ...
    List<CompanyResponse> companies =
        listCompaniesUseCase.list(page, size).stream().map(CompanyResponse::fromDomain).toList();
