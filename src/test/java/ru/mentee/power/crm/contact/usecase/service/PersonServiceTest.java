...
class PersonServiceTest {
  ...
  void create_WithEmptyFullName_ThrowsException() {
    ...
    IllegalArgumentException exception =
        assertThrows(IllegalArgumentException.class, () -> personService.create(fullName, email));
  ...
  void create_WithEmailConflict_ThrowsException() {
    ...
    IllegalStateException exception =
        assertThrows(IllegalStateException.class, () -> personService.create(fullName, email));
